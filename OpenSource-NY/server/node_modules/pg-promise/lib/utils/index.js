...
////////////////////////////////////////////////
// Detects general connectivity/session errors.
function isConnectivityError(err) {
    const code = err && typeof err.code === 'string' && err.code;
    const group = code && code.substr(0, 2);
    return code === 'ECONNRESET' || group === '08' || group === '57';
    // Code 'ECONNRESET' => Connectivity issue handled by the driver.
    // Code '08xxx' => Connection Exception.
    // Code '57xxx' => Operator Intervention.
    //
